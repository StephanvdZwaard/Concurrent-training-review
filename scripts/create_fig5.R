create_fig5 <- function(data) {
  ...
  A <- add_sub(A, "favors Strenght/Endurance Training ←                       → favors Concurrent Training", x = 0.5, y=0.1, hjust = 0.55, vjust = -2.05, vpadding=grid::unit(0, "lines"), size=9, color='darkgrey')
  ...
  # Save image as png
  tiff(paste0("Figure5_",format(Sys.Date(),"%d%m%y"),".tiff"),
